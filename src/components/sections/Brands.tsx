...
export const Brands = () => {
  ...
  return (
    <section id="marcas" className="py-20 bg-gradient-to-br from-gray-50 to-blue-50">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          {brandCategories.map((category, index) => {
            ...
            return (
              ...
              >
                <div className={`bg-gradient-to-br ${category.gradient} text-white w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-lg`}>
